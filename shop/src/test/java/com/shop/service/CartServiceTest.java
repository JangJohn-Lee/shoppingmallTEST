...
class CartServiceTest {
    ...
    public Item saveItem() {        //테스트 위해 장바구니에 담을 상품 저장
        Item item = new Item();
    ...
    public Member saveMember(){     //테스트를 위해 회원 정보를 저장하는 메소드 생성
    ...
    public void addCart(){
        ...
        cartItemDto.setCount(5);        //장바구니에 담을 상품과 수량cartItemDto 객체에 세팅
        ...
        CartItem cartItem = cartItemRepository.findById(cartItemId).orElseThrow(EntityNotFoundException::new);  //장바구니 상품 아이디를 이용하여 생성된 장바구니 상품 정보 조회
